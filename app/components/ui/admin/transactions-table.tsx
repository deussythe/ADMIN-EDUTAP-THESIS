                    ...
                    <table className="w-full">
                        <thead>
                            <tr className="border-b border-gray-200">
                                ...
                                <th className="text-left py-3 px-4 text-sm font-medium text-gray-700">Staff / Student</th>
                                ...
                                sorted.map((t) => (
                                    <tr key={t.id} className="border-b border-gray-100 hover:bg-gray-50">
                                        <td className="py-3 px-4 text-sm">
                                            <span className={`px-2 py-1 rounded-full text-xs font-medium ${t.type === 'topup'
                                        ...
                                        <td className="py-3 px-4 text-sm">
                                            <span className={`px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(t.status)}`}>
                                                {t.status === 'approved' || t.status === 'Approved' ? 'Approved' : t.status}
                                            </span>
                                        </td>
                                    </tr>
                                ))
